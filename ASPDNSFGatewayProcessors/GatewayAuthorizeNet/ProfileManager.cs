...
namespace GatewayAuthorizeNet
{
	public class ProfileManager
	{
		...
		public static string GetProfileDescription(string storeName)
		{
			storeName = string.IsNullOrWhiteSpace(storeName) 
				? AspDotNetStorefrontCore.AppLogic.AppConfig("StoreName") 
				: storeName;

			return String.Format("{0} CIM Profile", storeName);
		}
