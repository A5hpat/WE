	...
	public class OrderShipmentCollection : IEnumerable<OrderShipment>
	{
		...
		public OrderShipmentCollection(int orderNumber)
		{
            ...
            using(var connection = new SqlConnection(DB.GetDBConn()))
            {
				...
				using(var command = new SqlCommand("select OrderShipmentID, OrderNumber, AddressID, ShippingTotal from OrderShipment where OrderNumber = @orderNumber", connection))
				{
