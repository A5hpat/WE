...
namespace AssetServer
{
    ...
    {
		// TODO: Disabled until Application/Core circuluar dependency is resolved
		// See issue #233
		//private static String AssetServerURL //hardcoded for testing. we will need to pull the license guid dynamically.
		//{
		//	get
		//	{
		//		String url = "http://license.aspdotnetstorefront.com/Feed.aspx"; //default can be overridden with an app config
		//		if (!String.IsNullOrEmpty(AppLogic.AppConfig("AssetServerURL")))
		//			url = AppLogic.AppConfig("AssetServerURL");
		//		return url + "?LicenseGuid=" + AspDotNetStorefront.Licensing.LicenseInfo("id") + "&version=" + System.Reflection.Assembly.GetExecutingAssembly().GetName().Version.ToString();
		//	}
		//}
