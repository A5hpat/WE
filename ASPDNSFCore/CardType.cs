...
namespace AspDotNetStorefrontCore
{
	public class CardType
    {
        ...
        public static readonly CardType MasterCard = new CardType(new string[] {"51", "52", "53", "54", "55" }, new int[] {16 });
        ...
        public static readonly CardType Discover = new CardType(new string[] { "6011" }, new int[] { 16 });        
        public static readonly CardType EnRoute = new CardType(new string[] { "2014", "2149" }, new int[] { 15});
        public static readonly CardType JCB = new CardType(new string[] { "3", "2131", "1800" }, new int[] {15, 16 });
