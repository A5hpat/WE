...
namespace AspDotNetStorefrontControls
{
    ...
    { 
		...
		public string InitJS
        {
            get
            {
				return "new ToolTip('{0}', 'card-code-tooltip', '<iframe width=400 height=370 frameborder=0 marginheight=2 marginwidth=2 scrolling=no src=\"" + AppLogic.LocateImageURL("Skins/" + SkinProvider.GetSkinNameById(Customer.Current.SkinID) + "/images/verificationnumber.gif") + "\"></iframe>');";
            }
        }
        ...
        protected override void CreateChildControls()
        {
            ...
            if (_boolShowCCVerCd)
            {
				...
				ScriptManager.RegisterStartupScript(
					...
					GetType(), 
					"InitWhatsThisLink", 
					String.Format(InitJS, WhatsThisClientID),
					true);
