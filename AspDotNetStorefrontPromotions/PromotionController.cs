...
namespace AspDotNetStorefront.Promotions
{
	public interface IPromotionController
	{
		...
		IDiscountResult ApplyPromotion(IPromotionUsage promotionUsage, IRuleContext ruleContext, IDiscountContext discountContext, Func<IDiscountResult> resultFactory, IPromotionController promotionController);
