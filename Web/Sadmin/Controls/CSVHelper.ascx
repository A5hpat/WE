<%@ Control Language="C#" AutoEventWireup="true" Inherits="AspDotNetStorefrontControls.CSVHelper" Codebehind="CSVHelper.ascx.cs" %>
<%@ Register TagPrefix="aspdnsf" TagName="StoreSelector" Src="StoreSelector.ascx" %>
<div class="CSVHelper">
    <input type="text" id="<%= UniqueJSID %>SearchBox" />
    <input type="button" id="<%= UniqueJSID %>SearchButton" class="btn btn-default" onclick="Reload<%= UniqueJSID %>();" value="<%= CSVSearchButtonText %>" />
