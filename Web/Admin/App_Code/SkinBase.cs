...
namespace AspDotNetStorefront
{
	public class SkinBase : Page
	{
		...
		protected override void Render(System.Web.UI.HtmlTextWriter writer)
		{
			...
			{
                //nal SE_MetaTitle
                SETitle = "Wedding Enhancements - Enhancing your spcial day and beyond";
            }
			if(SEDescription.Length == 0)
			{
                // nal SE_MetaDescription
                SEDescription = "Wedding Enhancements - toys, games, beauty and health arousing and enhancing wedding night and beyond";
            }
			if(SEKeywords.Length == 0)
			{
                // nal SE_MetaKeywords
                SEKeywords = "Enhancement, Enhancing relationships, male enhancement,Relatinship Enhancement Toys,Romantic Guides,Bath,Body,Quality Lubricants,Fifty Shades of Grey ,For Fun,Fetish Fantasy,Stimulating Gels,Breast Enhancement ";
            }
            // nal 
