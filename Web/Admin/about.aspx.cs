...
namespace AspDotNetStorefrontAdmin
{
	public partial class about : AspDotNetStorefront.Admin.AdminPageBase
	{
		...
		protected void loadLicensing()
		{
			...
			var licenses = licenseValidationResult.Licenses;
			var permissionSet = licenseValidationResult.PermissionSet;
		...
		protected void loadLocalizationInformation()
		{
            ...
            // nal Localization.StoreCurrency
            ltLocalizationCurrencyCode.Text = "USD";
            // nal Localization.StoreCurrencyNumericCode
            ltLocalizationCurrencyNumericCode.Text = "840";
		}

		protected void loadGatewayInformation()
		{
			ltPaymentGateway.Text = AppLogic.ActivePaymentGatewayRAW();
			ltUseLiveTransactions.Text = (AppLogic.AppConfigBool("UseLiveTransactions") ? "LIVE" : "TEST");
		...
		protected void loadShippingInformation()
		{
            ...
            // nal RTShipping.OriginState
            ltOriginState.Text = "MI";
            // nal RTShipping.OriginZip
            ltOriginZip.Text = "48220";
            // nal RTShipping.OriginCountry
            ltOriginCountry.Text = "US";
            // nal FreeShippingThreshold
            // If set to a dollar amount (no $ or other currency symbol), orders equal to or greater than the amount specified here have free shipping. A value of 0.00 or blank disables this feature.
            ltFreeShippingThreshold.Text = "";
            // nal ShippingMethodIDIfFreeShippingIsOn
            // A comma-separated list of shipping method IDs (one or more integers) which are marked as having free shipping. You can see the shipping method IDs for your site from with admin. Choose Configuration, Shipping Calculation within Admin, then click View Real-Time Shipping Methods or View Shipping Methods to view shipping methods and their IDs.
            ltFreeShippingMethods.Text = "";
            // nal FreeShippingAllowsRateSelection
            ltFreeShippingRateSelection.Text = "On";
		}
