...
{
	public partial class bmlsettings : AspDotNetStorefront.Admin.AdminPageBase
	{
		...
		{
			AppConfigManager.SetAppConfigValue("PayPal.Ads.TermsAndConditionsAgreement", chkTermsAndConditions.Checked.ToString());
			InitializeTermsAndConditions();
		}
